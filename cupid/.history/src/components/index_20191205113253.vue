...
<mt-swipe :auto="4000" :style =" {width : getWidth, height: getHeight}" >
  <mt-swipe-item class="s1"><a href=""><img src="../assets/images/swipe1.jpg" alt=""></a></mt-swipe-item>
  <mt-swipe-item class="s2"><a href=""><img src="../assets/images/swipe2.jpg" alt=""></a></mt-swipe-item>
